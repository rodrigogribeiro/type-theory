...
\>[3]{}\K{data}\;\C{LTerm}\mathrel{=}\C{LVar}\;\C{String}{}\<[E]%
\\
\>[3]{}\hsindent{11}{}\<[14]%
\>[14]{}\mid \C{LLam}\;\C{String}\;\C{LTerm}{}\<[E]%
\\
\>[3]{}\hsindent{11}{}\<[14]%
\>[14]{}\mid \C{LApp}\;\C{LTerm}\;\C{LTerm}{}\<[E]%
\\
\>[3]{}\hsindent{11}{}\<[14]%
\>[14]{}\K{deriving}\;(\C{Eq},\C{Ord},\C{Show}){}\<[E]%
\ColumnHook
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\V{t1}\mathrel{=}\C{LLam}\;\text{\tt \char34 x\char34}\;(\C{LVar}\;\text{\tt \char34 x\char34}){}\<[E]%
\\
\>[3]{}\V{t2}\mathrel{=}\C{LLam}\;\text{\tt \char34 y\char34}\;(\C{LVar}\;\text{\tt \char34 y\char34}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
            \item Mas o teste de igualdade gerado pelo GHC não corresponde a isso,
                  pois o resultado de \ensuremath{\V{t1}\equiv \V{t2}} é \ensuremath{\C{False}}.
