...
\title{Estudo de Casos --- Objetos Imperativos}
...
\begin{document}
   \begin{frame}
      \titlepage
   \end{frame}
   \begin{frame}{Objetos Imperativos --- (I)}
       \begin{block}{O que Programação Orientada a Objetos?}
           \begin{itemize}
              \item Múltiplas representações.
              \item Encapsulamento.
              \item Subtipagem.
              \item Herança.
              \item Open recursion.
       ...
       \end{block}
   \end{frame}
   \begin{frame}{Objetos Imperativos --- (II)}
   \end{frame}
\end{document}
